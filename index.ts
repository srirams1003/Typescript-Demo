...
let josh : ManagerT & EmployeeT & PersonT = { // The '&' operator requires that your variable has all the properties of all the three types defined above
    name: 'josh',
    age: 34,
    salary: 5000,
...
let jake : ManagerT | EmployeeT | PersonT = { // The '|' operator requires that your variable has all the properties of at least one of the three types defined above
    name: 'jake',
    age: 37,
    salary: 7000,
...
// // cannot be done as a type cannot extend a type
// type EmployeeT2 extends PersonT2 = {
//     salary: number;
// }
